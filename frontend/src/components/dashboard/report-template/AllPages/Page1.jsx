  ...
  return (
    <div>
      ...
      >
        ...
        >
          Lic No. Lic No. IRDA/CORP/SLA-200018 DOE 07.02.2025
        </span>
        <br />
      </div>
      ...
      >
        ...
        >
          ...
          {allInfo?.otherInfo[0]?.SettlementType})- (NIL DEPRECIATION)
        </span>
        <span
          style={{
            fontStyle: "normal",
      ...
      >
        ...
        >
          loss/damages and subject to the terms and conditions of the insurance
          policy. loss/damages and subject to the terms and conditions of the
          insurance policy.{" "}
        </span>
        <span
          style={{
      ...
      >
        ...
        >
          {allInfo?.otherInfo[0]?.RegisteredOwner}
        </span>
        <span
          style={{
            fontStyle: "normal",
        ...
        >
          {allInfo?.otherInfo[0]?.OwnerSerialNo}
        </span>
        <span
          style={{
            fontStyle: "normal",
      ...
      >
        ...
        >
          {allInfo?.otherInfo?.TypeOfBody} {allInfo?.otherInfo?.ClassOfVehicle}{" "}
        </span>
        <span
          style={{
            fontStyle: "normal",
        ...
        >
          {allInfo?.otherInfo?.PreAccidentCondition}
        </span>
        <span
          style={{
            fontStyle: "normal",
        ...
        >
          {allInfo?.otherInfo?.SeatingCapacity}{" "}
        </span>
        <span
          style={{
            fontStyle: "normal",
      ...
      >
        <div style={{ position: "relative", left: "0.27in" }}>
          ...
          >
            Type of Body and Class of vehicle{" "}
          </span>
          <span
            style={{
              fontStyle: "normal",
      ...
      >
        <div style={{ position: "relative", left: "0.27in" }}>
          ...
          >
            {allInfo?.otherInfo?.CubicCapacity}{" "}
          </span>
          <span
            style={{
              fontStyle: "normal",
      ...
      >
        ...
        >
          {allInfo?.otherInfo[0]?.TaxParticulars}
        </span>
        <span
          style={{
            fontStyle: "normal",
        ...
        >
          {allInfo?.otherInfo[0]?.ModeOfCheck}
        </span>
        <span
          style={{
            fontStyle: "normal",
      ...
      >
        <div style={{ position: "relative", left: "0.27in" }}>
          ...
          >
            {" "}
            {allInfo?.otherInfo[0]?.LicenseType}
          </span>
          <br />
        </div>
        <span
      ...
      >
        <div style={{ position: "relative", left: "0.27in" }}>
          ...
          >
            {" "}
            {allInfo?.otherInfo[0]?.IssuingAuthority}
          </span>
          <br />
        </div>
        <span
      ...
      >
        ...
        >
          {" "}
          {allInfo?.otherInfo[0]?.ValidUntilNtv}
        </span>
        <br />
        <span
          style={{
        ...
        >
          {" "}
          {allInfo?.otherInfo[0]?.ValidUntilTv}
        </span>
        <br />
      </div>
      ...
      >
        <div style={{ position: "relative", left: "0.27in" }}>
          ...
          >
            {" "}
            {allInfo?.otherInfo[0]?.DateOfAccident}
          </span>
          <br />
        </div>
        <span
      ...
      >
        ...
        >
          {" "}
          {formatJustDate(allInfo?.otherInfo[0]?.DateOfAccident)}
        </span>
      </div>
      ...
      >
        <div style={{ position: "relative", left: "1.19in" }}>
          ...
          >
            {formatTime(allInfo?.otherInfo[0]?.DateOfAccident)}{" "}
          </span>
          <span
            style={{
              fontStyle: "normal",
        ...
        >
          {allInfo?.otherInfo[0]?.PlaceOfLoss}{" "}
        </span>
        <span
          style={{
            fontStyle: "normal",
      ...
      >
        <div style={{ position: "relative", left: "0.50in" }}>
          ...
          >
            Address : 58-Gandhi Nagar,Near Bal Niketan School, Sri
        ...
        >
          : B-43,NFL Society,Sector-PI, Gr Noida-201310./ E-201,MAPSKO
