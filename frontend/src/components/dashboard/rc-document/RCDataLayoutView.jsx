...
const RCDataLayoutView = ({ vehicleDetails }) => {
  let rcDetails = {
  ...
  useEffect(() => {
    let rcDetailsUpdated = {
      "Chassis No.":
        vehicleDetails?.ChassisNumber !== "undefined"
          ? vehicleDetails?.ChassisNumber
          : "N.A.",
      "Engine No.":
        vehicleDetails?.EngineNumber !== "undefined"
          ? vehicleDetails?.EngineNumber
          : "N.A.",
      "Maker Name":
        vehicleDetails?.MakerDesc !== "undefined"
          ? vehicleDetails?.MakerDesc
          : "N.A.",
      "Model Name":
        vehicleDetails?.MakerModel !== "undefined"
          ? vehicleDetails?.MakerModel
          : "N.A.",
      "Registration Date":
      ...
      "Vehicle Type":
        vehicleDetails?.VehicleType !== "undefined"
          ...
          : "N.A.",
      "Type Of Body":
        vehicleDetails?.TypeOfBody !== "undefined"
          ? vehicleDetails?.TypeOfBody
          : "N.A.",
      "Fuel Type":
        vehicleDetails?.FuelType !== "undefined"
          ? vehicleDetails?.FuelType
          : "N.A.",
      "Tax Particulars":
        vehicleDetails?.TaxParticulars !== "undefined"
          ? vehicleDetails?.TaxParticulars
          : "N.A.",
      Color:
        vehicleDetails?.MakeVariantModelColor !== "undefined"
          ? vehicleDetails?.MakeVariantModelColor
          : "N.A.",

      "Class Of Vehicle":
        vehicleDetails?.ClassOfVehicle !== "undefined"
          ? vehicleDetails?.ClassOfVehicle
          : "N.A.",
      "Seat Capacity":
        vehicleDetails?.SeatingCapacity !== "undefined"
          ? vehicleDetails?.SeatingCapacity
          : "N.A.",
      "Cubic Capacity":
        vehicleDetails?.CubicCapacity !== "undefined"
          ? vehicleDetails?.CubicCapacity
          : "N.A.",
      "Registered Owner":
        vehicleDetails?.RegisteredOwner !== "undefined"
          ? vehicleDetails?.RegisteredOwner
          : "N.A.",
      "Insurance Company":
        vehicleDetails?.VehicleInsuranceCompany !== "undefined"
          ? vehicleDetails?.VehicleInsuranceCompany
          : "N.A.",
      "Manufacture Month Year":
        vehicleDetails?.ManufactureMonthYear !== "undefined"
          ? vehicleDetails?.ManufactureMonthYear
          : "N.A.",
      "Insurance Valid UpTo":
        vehicleDetails?.VehicleInsuranceUpto !== "undefined"
          ? vehicleDetails?.VehicleInsuranceUpto
          : "N.A.",
      "Vehicle Rc Status":
        vehicleDetails?.VehicleRcStatus !== "undefined"
          ? vehicleDetails?.VehicleRcStatus
          : "N.A.",
      "PUCC No.":
        vehicleDetails?.PucNumber !== "undefined"
          ? vehicleDetails?.PucNumber
          : "N.A.",
      "PUCC Valid Upto":
        vehicleDetails?.PucValidUntil !== "undefined"
          ? vehicleDetails?.PucValidUntil
          : "N.A.",
      "Registering Authority":
        vehicleDetails?.VehicleRegistedAt !== "undefined"
          ? vehicleDetails?.VehicleRegistedAt
          : "N.A.",
    };
...
export default RCDataLayoutView;
