...
const Index = () => {
  ...
  useEffect(()=>{
    let filterClaim;
  if (type === 1) {
    filterClaim = allClaims.filter((claim, index) => claim?.PolicyNo?.toLowerCase().includes(searchInput.toLowerCase()));
  } else if (type === 2) {
    filterClaim = allClaims.filter((claim, index) => claim?.RegistrationNo?.toLowerCase().includes(searchInput.toLowerCase()));
  } else {
    filterClaim = allClaims.filter((claim, index) => claim?.ReferenceID?.toLowerCase().includes(searchInput.toLowerCase()));
  }
          ...
          <div className="row">
            <div className="col-lg-12 maxw100flex-992">
              ...
              <div className="row">
                ...
                <Exemple claims={searchInput  || majorSearch  || isRegionChange ? filterClaims : allClaims} setMajorSearch={setMajorSearch} />
