    ...
    if (userInfo === "") {
      ...
      axios
        ...
        .then((res) => {
          ...
          let specificParams = [];
          allRegionsInfo.map((region, index) => {
            specificParams.push(region.Region);
          });

          specificParams.push(userInfo[0].CalimStatus);
          const specificParamsJSON = JSON.stringify(specificParams);
          axios
            .get("/api/getAllClaims", {
              params: {
                specificParams: encodeURIComponent(specificParamsJSON),
              },
              headers: {
            ...
            .then((res) => {
              ...
              setFilterClaims(res.data.data[0]);
            })
            .catch((err) => {
              toast.dismiss();
                ...
                <div className="col-lg-12 mt20">
                  <div className="mbp_pagination">
                    <Pagination
                      ...
                      properties={getRequiredClaimsForPagination()}
                    />
                  </div>
                </div>
              </div>
