        ...
        return (
            <React.Fragment>
                ...
                <span style={{ marginLeft: '.5em', verticalAlign: 'middle' }}>
                    <Link href="uikit/claimform_2">{rowData.country.name}</Link>
                </span>
            </React.Fragment>
        );
    };
            ...
            {/* <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        header={header1}
                    >
                        <Column field="name" header="PB Reference ID" filter filterPlaceholder="Search by name" style={{ minWidth: '12rem' }} />
                        <Column
                        ...
                        />
                        <Column field="name" header="Policy No." filter filterPlaceholder="Search by name" style={{ minWidth: '12rem' }} />
                        <Column
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable value={customers2} scrollable scrollHeight="400px" loading={loading2} className="mt-3">
                        <Column field="id" header="S.No." style={{ flexGrow: 1, flexBasis: '60px' }} frozen={idFrozen} alignFrozen="left" bodyClassName={classNames({ 'font-bold': idFrozen })}></Column>
                        <Column field="name" header="Document Name" style={{ flexGrow: 1, flexBasis: '200px' }} frozen className="font-bold"></Column>
                        ...
                        <Column field="balance" header="Action" body={balanceTemplate} frozen style={{ flexGrow: 1, flexBasis: '120px' }} className="font-bold" alignFrozen="right"></Column>
                    </DataTable>
                </div>
            </div>
