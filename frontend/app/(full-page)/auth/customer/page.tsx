...
import TableDemo from '../../../(main)/uikit/customer/page';
            ...
            <div className="col-12">
                <div className="card">
                    <div className="flex flex-column align-items-center justify-content-center">
                        <img src={`/layout/images/logo-${layoutConfig.colorScheme === 'light' ? 'dark' : 'white'}.svg`} alt="Sakai logo" className="w-6rem flex-shrink-0" />
                        <div
                            style={{
                                borderRadius: '0px',
                                padding: '0.3rem',
